    ...
    <div class='top-padding'>
        <div class='pfp-flex'>
            <div class='md:w-1/2 w-screen text-margin'>
                <p class='sub-text'>
                    <br /><br />
                    <bold class='hight-light-text-gry'>!</bold> Visit our <a class='saho'
                        href='https://github.com/Mauler125/r5sdk'>Github</a>. <br>
                    <bold class='hight-light-text-gry'>!</bold> Join our <a class='saho'
                        href='https://discord.gg/r5reloaded'>Discord</a>. <br>
                    <bold class='hight-light-text-gry'>!</bold> Go to our <a class='saho'
                        href='https://twitter.com/r5reloaded'>Twitter</a>. <br>
                </p>
            </div>
        </div>
    </div>
